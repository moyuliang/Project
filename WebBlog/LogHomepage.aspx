<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogHomepage.aspx.cs" Inherits="WebBlog.LogHomepage" %>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="active navbar-brand">主页</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">个人主页</asp:LinkButton></li>              
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                    <asp:LinkButton ID="LinkButton44" runat="server" OnClick="LinkButton44_Click">文章类型</asp:LinkButton></li>
                  <li>
                      <asp:LinkButton ID="LinkButton46" runat="server" OnClick ="LinkButton46_Click">添加文章</asp:LinkButton></li>
                <li role="separator" class="divider"></li>
                <li>
                    <asp:LinkButton ID="LinkButton45" runat="server" OnClick="LinkButton45_Click">查看文章</asp:LinkButton></li>
              </ul>
           </li>
            <li><a href="image.aspx">图片管理</a></li>
            <li>
                <asp:LinkButton ID="LinkButton48" runat="server" OnClick="LinkButton48_Click">博客管理</asp:LinkButton></li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                        <asp:LinkButton ID="LinkButton47" runat="server" OnClick="LinkButton47_Click">个人设置</asp:LinkButton></li>
                    <li role="separator" class="divider"></li>
